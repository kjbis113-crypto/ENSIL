...
export const CREATURE_RECORDS: CreatureRecord[] = [
  {
    ...
    status: 'LIVE MODEL',
    palette: { primary: '#73D2BE', secondary: '#5FA48D', accent: '#545756', paper: '#73D2BE', ink: '#171818' },
  ...
  },
  {
    ...
    status: 'LIVE MODEL',
    palette: { primary: '#5FA48D', secondary: '#73D2BE', accent: '#545756', paper: '#5FA48D', ink: '#171818' },
