...
export const CREATURE_RECORDS: CreatureRecord[] = [
  {
    ...
    status: 'LIVE MODEL',
    palette: { primary: '#73D2BE', secondary: '#5FA48D', accent: '#545756', paper: '#FFFFFF', ink: '#171818' },
  ...
  },
  {
    ...
    status: 'LIVE MODEL',
    palette: { primary: '#5FA48D', secondary: '#73D2BE', accent: '#545756', paper: '#FFFFFF', ink: '#171818' },
